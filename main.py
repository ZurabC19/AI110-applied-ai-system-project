...
def main():
    ...
    # 9. Agentic AI Advisor
    separator("Running AI Advisor (3-step agent)")
    try:
        advisor = PawPalAdvisor(owner, verbose=True)
        result = advisor.run()
        separator("Agent steps summary")
        print(advisor.get_steps_summary())
